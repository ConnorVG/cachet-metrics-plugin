...
namespace CachetHQ\Plugins\Metrics\Http\Controllers\Dashboard;
...
class MetricController extends Controller
{
    ...
    public function showMetrics()
    {
        ...
        return View::make('connorvg/cachet-metrics-plugin::dashboard.metrics.index')
    ...
    {
        return View::make('connorvg/cachet-metrics-plugin::dashboard.metrics.add')
    ...
    {
        return View::make('connorvg/cachet-metrics-plugin::dashboard.metrics.points.index')
    ...
    {
        return View::make('connorvg/cachet-metrics-plugin::dashboard.metrics.points.add')
    ...
    {
        return View::make('connorvg/cachet-metrics-plugin::dashboard.metrics.edit')
